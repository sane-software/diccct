...
// Entry point. SaneDictCcDictionary is a menu-bar-only agent: no Dock icon, no main menu bar.
...
// from the assembled SaneDictCcDictionary.app bundle or directly via `swift run`.
//
